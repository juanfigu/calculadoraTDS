...
if(promedioPj == 1){
    $("#divResult").html("Tu personaje tiene vida promedio, osea es una cagada");
} else if(promedioPj > 1){
    $("#divResult").html("Tu personaje esta arriba de vida, bien ahi perro.");
} else if(promedioPj < 1){
    $("#divResult").html("Tu personaje esta abajo del promedio de vida, felicitaciones por el tiempo que perdiste panflin");
}
